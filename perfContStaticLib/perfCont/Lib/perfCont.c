 ...
 * @param timeCnt Zamanlayýcý sayacý
 * @param me Performans kontrol yapý göstericisi
 ...
 * @param funcId Kayýt edilecek funksiyon numarasý
 * @param me Performans kontrol yapý göstericisi
 * @return perContStatus Durum bildirimi
 */
 ...
 * @param pram  Performans kontrol döngü parametreleri yapý göstericisi
...
/**
 * perfCont_seqUpdate
 * @param control Min Max deðerler yapý göstericisi
 * @param perfCont  Performans kontrol döngü parametreleri yapý göstericisi
 * @return retVal Min max durum bildirimi
 */
 ...
 * @param perfCont  Performans kontrol parametreleri yapý göstericisi
 */
 ...
 * @param me Performans kontrol yapý göstericisi
 * @param mesStruct Performans kontrol döngü mesaj içeriði yapý göstericisi
 * @return size Performans kontrol döngü mesaj içeriði boyutu
 */
 ...
 * @param funcId Talep edilen fonksiyon numarasý
 * @param me Performans kontrol yapý göstericisi
 * @param mesStruct Performans kontrol fonksiyon mesaj içeriði yapý göstericisi
 * @return size Performans kontrol fonksiyon mesaj içeriði boyutu
 */
 ...
 * @param me Performans kontrol yapý göstericisi
 * @return funcSize Kayýt edilen funksiyon sayýsý
 */
